...
if __name__ == "__main__":
    ...
    print(f"SB_REF:             {extract_tag_number(plotTags['sb_ref'])}")
    print(f"SB_1934:            {extract_tag_number(plotTags['sb_1934'])}")
    print(f"SB_HOLO:            {extract_tag_number(plotTags['sb_holo'])}")
    print(f"SB_TARGET_1934:     {extract_tag_number(plotTags['sb_target_1934'])}")
    print("-"*60)
