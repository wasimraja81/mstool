#!/bin/bash
# TEST 1: chanMedian amplitude channel mode
# Copy of RF-midband-spectral.sh with BP_UPDATE_MODIFY_AMP_CHANNEL_MODE changed
# from "perChannel" to "chanMedian" to assess which mode is optimal for midband.
...
# TEST 1: using chanMedian instead of perChannel
